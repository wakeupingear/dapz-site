...
export default function Banner() {
    ...
    return <div id="banner">
        {(window.location.pathname === "/")
            ...
            : <a id="bannerName" className='dropShadow' href={homeURL} rel='noreferrer' target={"_self"}>Dapz</a>
        }
        <div id="socials" className='dropShadow'>
            ...
            <SocialLink name="YouTube" link="https://www.youtube.com/c/Dapz1" className="socialLast" />
            <SocialLink name="corner" />
        </div>
    </div>;
}